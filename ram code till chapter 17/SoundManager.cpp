...
SoundManager::SoundManager()
{
	...
	// The sound reduces steaily as the player moves further away;
	//(The Higher the number the more quicker the sound will decrease);
	...
	// Set all the minimum diatance levels;
...
void SoundManager::playFire(Vector2f emitterLocation, Vector2f listenerLocation)
{
	...
	case 1:
		...
		{
			// Play the Sound if it is not played already;
			m_Fire1Sound.play();
		}
		break;
	case 2:
	...
	case 3:
		...
		// Increment to th next fire sound;
		m_NextSound++;
